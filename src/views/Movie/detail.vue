...
.detail_player .swiper-slide{ width:100px;height:70px; margin-right: 20px; text-align: center; font-size: 14px;}
.detail_player .swiper-slide div{
    height:100%;
}
.detail_player .swiper-slide img{ width:100%;height:100%; margin-bottom: 5px;}
