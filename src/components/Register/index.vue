...
<div class='register_body'>
    ...
    邮箱:<input v-model="email"   type="text" class="register_text"  /> <button type="primary" @touchstart="handleToVerify" :disable="disabled">{{verifyInfo}}</button>
    </div>
    <div>
...
.register_body .register_btn button{ width:100%; height:100%; background:#e54847; border-radius: 3px; border:none; display: block; color:white; font-size: 20px;cursor:pointer;}
