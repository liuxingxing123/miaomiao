<template>
    <div class="password_body">
        ...
        <div class="password_btn"><button @touchstart="handleToPassword">修改</button></div>
...
.password_body .password_btn button{ width:100%; height:100%; background:#e54847; border-radius: 3px; border:none; display: block; color:white; font-size: 20px;cursor:pointer;}
